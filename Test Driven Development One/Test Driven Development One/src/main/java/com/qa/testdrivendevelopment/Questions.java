...
public class Questions {
	...
	public String multiChar(String input) {
		String a = ("The");
			(a.new.multiChar(3));
		return word;
		    		//you need multi char with a int of 3
	...
	public String sandwichFilling(String sandwich) {
		//need to use substring to manipulate what is between bread
		//i do not knwo how to implement
		return "";
	}
	...
	public boolean endsJava(String input) {
		public static void main(String[] args) {  
			String str = "welovejava";
			if(str.endsWith("java")) {
				System.out.println("True");
						   }
		}
		
		//need to conditionals
    	return false;
	}
	...
	public int amISearch(String sentence) {
    	return -1;
    	//nneed to use substring index of
	}
	...
	public String fizzBuzz(int number) {
		...
		return("fizzbuzz");
					// i know you need ,and/or but cannot implement it
	}
