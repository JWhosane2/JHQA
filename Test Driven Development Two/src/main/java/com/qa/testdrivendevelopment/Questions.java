...
public class Questions {
	...
	public int returnPosition(String input, char letter) {
			return 0;
	}//not sure , attempted but cannot figure out
	...
	public String[] csvScan(String csvInput) {
		return null;
	}// attempted, do not understand how to implement 
	...
	}// not too sure how to do it, need a array
	 ...
	 */
	public boolean iBeforE(String input) {
